const abi = [
    ...
    {
        "inputs": [],
        "name": "getAllBaseTicks",
        "outputs": [
            {
                "components": [
                    {
                        "internalType": "uint256",
                        "name": "token0AmountLocked",
                        "type": "uint256"
                    },
                    {
                        "internalType": "uint256",
                        "name": "token1AmountLocked",
                        "type": "uint256"
                    },
                    {
                        "internalType": "uint256",
        ...
        "outputs": [
            {
                ...
                "internalType": "struct LPTokenTick[]",
                "name": "",
                "type": "tuple[]"
            }
        ],
